...
function Footer() {
  return (
    <footer className=" md:grid mb-16 md:mb-0  cursor-default capitalize  grid-cols-3 gap-y-10 lg:px36 pt-0  py-10 px-4 md:px-16 bg-gray-800 text-white relative">
      <ScrollUp />
